...
{
    public partial class AMATUERLog : Form
    {
        ...
        private void signService()
        {
            ...
            string query = "INSERT INTO `mydb`.`kliento_abonementas` (`galiojimo_pradzia`, `galiojimo_pabaiga`, `kliento_id`, `narystes_id`) VALUES (null, null, (SELECT kliento_id FROM klientas WHERE vardas = '" + user_name + "'), 2);";
