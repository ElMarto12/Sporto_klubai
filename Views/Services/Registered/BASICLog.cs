...
{
    public partial class BASICLog : Form
    {
        ...
        private void show_services()
        {
            ...
            string query = "SELECT paslaugos_pavadinimas AS Paslauga FROM narystes_paslauga WHERE narystes_id = 1";
        ...
        private void show_duration()
        {
            ...
            string query = "SELECT trukme_men FROM naryste WHERE narystes_id = 1;";
        ...
        private void show_price()
        {
            ...
            string query = "SELECT menesine_kaina FROM naryste WHERE narystes_id = 1;";
        ...
        //uzregistruoja klientui naryste
        private void signService()
        {
            MySqlCommand cmd = null;

            string query = "INSERT INTO `mydb`.`kliento_abonementas` (`galiojimo_pradzia`, `galiojimo_pabaiga`, `kliento_id`, `narystes_id`) VALUES (null, null, (SELECT kliento_id FROM klientas WHERE vardas = '"+user_name+"'), 1);";
